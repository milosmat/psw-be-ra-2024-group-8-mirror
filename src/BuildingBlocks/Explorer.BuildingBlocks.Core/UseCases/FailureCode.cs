...
public static class FailureCode
{
    ...
    public static readonly IError BadRequest = new Error("Invalid data.")
       .WithMetadata("code", 400);
    ...
    public static readonly IError CouponGenerationFailed = new Error("Coupon generation failed.")
        .WithMetadata("code", 500);

    public static readonly IError CouponNotFound = new Error("No available coupons found.")
        .WithMetadata("code", 404);

    public static readonly IError CouponExpired = new Error("Coupon has expired.")
        .WithMetadata("code", 400);

    public static readonly IError CouponNotApplicable = new Error("Coupon code does not match any items in the cart.")
        .WithMetadata("code", 400);
}