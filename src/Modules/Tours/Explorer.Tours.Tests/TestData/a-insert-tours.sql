...
INSERT INTO tours."Tours"(
	...
	VALUES (-1, 'Name1', 'Description1', 'Weight1', '{{"Tags1"}}', 0, 255, 1500, '2024-10-14 15:23:44.223+02', '2024-10-24 15:23:44.223+02', '[{{}}]', '[{{}}]', -22);

INSERT INTO tours."Tours"(
	"Id", "Name", "Description", "Weight", "Tags", "Status", "Price", "LengthInKm", "PublishedDate", "ArchivedDate", "TravelTimes", "DailyAgendas", "AuthorId")
	VALUES (-2, 'Name2', 'Description2', 'Weight2', '{{"Tags2"}}', 0, 400, 2000, '2024-10-14 15:23:44.223+02', '2024-10-24 15:23:44.223+02', '[{{}}]', '[{{}}]', -23);

INSERT INTO tours."Tours"(
	"Id", "Name", "Description", "Weight", "Tags", "Status", "Price", "LengthInKm", "PublishedDate", "ArchivedDate", "TravelTimes", "DailyAgendas", "AuthorId")
	VALUES (-3, 'Name3', 'Description3', 'Weight3', '{{"Tags3"}}', 0, 300, 3000, '2024-10-04 15:23:44.223+02', '2024-10-29 15:23:44.223+02', '[{{}}]', '[{{}}]', -21);
